...
function CardCSE(props : CardCursoServicoEquipamentoProps){
    return (
        <div className="bg-red-700 w-72 h-[500px] p-3 rounded-lg flex flex-col gap-2 items-center aspect-square">
            ...
            <NavLink to={`/cursos/${props.id}`} className="w-full bg-slate-200 hover:bg-slate-300 duration-150 ease-in rounded-md text-center p-2 hover:scale-105 font-[inter]">Saber mais</NavLink>
        </div>
    )  
}
