...
function CardDivisao(props: CardDivisaoProps) {
    ...
    return (
        <a className={`transition-all duration-300 ease-in-out flex flex-col items-center justify-center ${background} bg-gray-400 hover:bg-blend-multiply w-72 h-[500px] rounded-2xl border-4 border-transparent hover:border-gray-700 p-4`} onMouseEnter={() => setIsHovered(true)} onMouseLeave={() => setIsHovered(false)}>
